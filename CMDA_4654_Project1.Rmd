...
ggplot(data = accuracy_df, aes(x = K, y = Accuracy)) +
  geom_line() +
  geom_point() +
  geom_point(data = accuracy_df[max_accuracy_index, ], aes(x = K, y = Accuracy), color = "red", size = 3) +  # Highlight point with red color and larger size
